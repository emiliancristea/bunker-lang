...
| 9 | `modules/driver.bkr` | `COMPILER DRIVER` | Orchestrate lex, parse, codegen, diagnostics, capability reports, AST tree reports, type graph reports, symbol table reports, resolver reports, file I/O, and process exit. |
...
| `modules/driver.bkr` | `compile_to_c`, `main`, self-host diagnostic JSON helpers, self-host capability report helpers, self-host AST tree report helpers, self-host type graph report helpers, self-host symbol table report helpers, and self-host resolver report helpers. |
