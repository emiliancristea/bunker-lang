...
| `modules/resolver.bkr` | `build_resolver_report_comment`, `self_host_resolver_json`, and bootstrap resolver diagnostics helpers that consume typed AST refs, typed AST collection refs, semantic top-level item/kernel accessors, and semantic statement/block accessors. |
