...
| 9 | `modules/driver.bkr` | `COMPILER DRIVER` | Orchestrate lex, parse, codegen, diagnostics, capability reports, AST summary reports, file I/O, and process exit. |
...
| `modules/driver.bkr` | `compile_to_c`, `main`, self-host diagnostic JSON helpers, self-host capability report helpers, and self-host AST summary report helpers. |
